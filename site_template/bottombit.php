        <div class="box side">
           ...
           <form class="searchform" method="post" action="name_dev.php" enctype="multipart/form-data">
               ...
               <input class="search" type="text" name="dev_name" size="25" value="" required placeholder="App Name / Developer Name..."/>
            ...
            <!-- No In App Checkbox -->
            <input class="adv-txt" type="checkbox" name="in_app"
            value="0">No In App Purchase
            <!-- Rating -->
            <div class="flex-container">
                <div class="adv-text">
                    Rating:
                ...
                <div>
                    <input class="adv" type="text" name="rating" size="3"
                    value="" placeholder=""/>
                </div> <!-- / rating amount -->
            </div> <!-- / rating flex box -->
